...
${OBJECTDIR}/MyService.o: MyService.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MyService.o MyService.cpp
...
${OBJECTDIR}/myclientapplication.o: myclientapplication.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/myclientapplication.o myclientapplication.cpp

${OBJECTDIR}/myserviceclientrunnable.o: myserviceclientrunnable.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/myserviceclientrunnable.o myserviceclientrunnable.cpp

${OBJECTDIR}/thrift_file_constants.o: thrift_file_constants.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift_file_constants.o thrift_file_constants.cpp

${OBJECTDIR}/thrift_file_types.o: thrift_file_types.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift_file_types.o thrift_file_types.cpp
