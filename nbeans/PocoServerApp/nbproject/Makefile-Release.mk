...
${OBJECTDIR}/myserverapplication.o: myserverapplication.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/myserverapplication.o myserverapplication.cpp

${OBJECTDIR}/myservicehandler.o: myservicehandler.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/myservicehandler.o myservicehandler.cpp
